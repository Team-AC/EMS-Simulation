...
class EnergyControl:
    def __init__(self, bess, schedule, ev_parameters_dict, bess_parameters_dict, sio, historical_start_time):
        ...
        # self.hour_check = self.internal_clock.replace(second=0, microsecond=0, minute=0, hour=self.internal_clock.hour) + timedelta(hours=self.internal_clock.minute//30)
